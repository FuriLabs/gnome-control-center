 ...
 * Copyright (C) 2026 Bardia Moshiri <fakeshell@bardia.tech>
 *
...
void read_batman_config (void);
int update_config_value (const char* config_key, const char* config_value);
int update_batman_config_value (const char* config_key, const char* config_value);
