...
extern GType cc_assistant_panel_get_type (void);
...
extern GType cc_andromeda_panel_get_type (void);
...
extern GType cc_face_panel_get_type (void);
#ifdef BUILD_WACOM
...
//    PANEL_TYPE ("search", cc_search_panel_get_type, NULL),
    PANEL_TYPE ("andromeda", cc_andromeda_panel_get_type, NULL),
    ...
    PANEL_TYPE ("face", cc_face_panel_get_type, NULL),
#ifdef BUILD_WACOM
