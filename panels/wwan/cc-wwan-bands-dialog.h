...
#define CC_TYPE_WWAN_BANDS_DIALOG (cc_wwan_bands_dialog_get_type())
G_DECLARE_FINAL_TYPE (CcWwanBandsDialog, cc_wwan_bands_dialog, CC, WWAN_BANDS_DIALOG, GtkDialog)

GtkWindow *cc_wwan_bands_dialog_new (GtkWindow *parent_window, CcWwanDevice *device);
