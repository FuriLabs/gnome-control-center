...
cc_wwan_data_class_init (CcWwanDataClass *klass)
{
    ...
    properties[PROP_ENABLED] =
        g_param_spec_boolean ("enabled", NULL, NULL, FALSE, G_PARAM_READABLE | G_PARAM_STATIC_STRINGS);
...
/**
 * cc_wwan_data_apn_get_initial_eps_auth_method:
 * @apn: A #CcWwanDataApn
 *
...
/**
 * cc_wwan_data_apn_set_initial_eps_auth_method:
 * @apn: A #CcWwanDataApn
