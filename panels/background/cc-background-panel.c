...
struct _CcBackgroundPanel {
    ...
    AdawPreferencesGroup *status_indicator_group;
...
reload_fit_row (CcBackgroundPanel *self)
{
    ...
    /* Anything unrecognised shows as Fill without writing it back */
...
on_wallpaper_folder_clicked_cb (CcBackgroundPanel *self)
{
    ...
    gtk_file_filter_add_mime_type (filter, "image/heic");
    gtk_file_filter_add_mime_type (filter, "image/heif");
