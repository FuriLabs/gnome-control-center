                                    ...
                                    gpointer user_data)
{
    ...
    if (!response && !g_error_matches (error, G_IO_ERROR, G_IO_ERROR_CANCELLED))
...
#if IS_FURIOS
        g_signal_connect_object (self->enable_switch, "notify::active", G_CALLBACK (wwan_enable_switch_changed_cb),
